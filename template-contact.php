<?php
/**
 * Template Name: Abadi Event - Contact
 */
...
<section class="ae-page-hero">
    <div class="ae-container">
        ...
        <p>Tim kami siap membantu menyusun konsep, desain, dan anggaran sesuai kebutuhan brand Anda — biasanya kami merespons dalam 30 menit pada jam kerja.</p>
    </div>
</section>
...
<section class="ae-section">
    <div class="ae-container">
        <div class="ae-quick-contact-grid">
            <a href="https://wa.me/6281227447888?text=<?php echo rawurlencode('Halo Abadi Event, saya mau tanya soal jasa pameran.'); ?>" target="_blank" class="ae-quick-card">
                ...
                <div>
                    ...
                    <strong>0812-2744-7888</strong>
                    <small>Senin – Sabtu, 08.00 – 17.00 WIB</small>
                </div>
            </a>

            <a href="mailto:info@abadievent.id" class="ae-quick-card">
                <div class="ae-quick-icon">
                ...
                <div>
                    ...
                    <strong>info@abadievent.id</strong>
                    <small>Respons dalam 1×24 jam pada hari kerja</small>
                </div>
            </a>

            <a href="https://maps.google.com/?q=Jl.+Godo+Inten+UH+VI+No.50E,+Sorosutan,+Yogyakarta" target="_blank" class="ae-quick-card">
                <div class="ae-quick-icon">
                ...
                <div>
                    ...
                    <strong>Sorosutan, Yogyakarta</strong>
                    <small>Jl. Godo Inten UH VI No.50E, Umbulharjo</small>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="ae-container ae-contact-grid">
        <div class="ae-contact-info">
            ...
            <ul class="ae-contact-list">
                <li>
                    ...
                    <div><strong>Telepon &amp; WhatsApp</strong><a href="https://wa.me/6281227447888" target="_blank">0812-2744-7888</a></div>
                </li>
                <li>
                    ...
                    <div><strong>Email</strong><a href="mailto:info@abadievent.id">info@abadievent.id</a></div>
                </li>
                <li>
                    ...
                    <div><strong>Alamat Kantor</strong>Jl. Godo Inten UH VI No.50E,<br>Sorosutan, Umbulharjo,<br>Yogyakarta 55162</div>
                </li>
                <li>
                    ...
                    <div><strong>Jam Operasional</strong>Senin – Sabtu<br>08.00 – 17.00 WIB</div>
                </li>
                <li>
                    ...
                    <div><strong>Rating Google Business</strong>5.0 dari 5 (6 ulasan)</div>
                </li>
            </ul>
        </div>
        ...
        <div class="ae-contact-form-wrapper">
            <div class="ae-contact-form-card">
                ...
                <p>Isi formulir di bawah — pesan akan diteruskan langsung ke WhatsApp tim kami dengan data yang sudah terformat rapi.</p>

                <form action="https://wa.me/6281227447888" method="get" target="_blank" id="ae-quote-form" class="ae-contact-form">
                    <input type="hidden" name="phone" value="6281227447888">
                    ...
                    <div class="ae-form-row">
                        ...
                        <label>Lokasi Acara
                            <input type="text" id="qf-loc" placeholder="Contoh: JEC Yogyakarta">
                        </label>
                    </div>
                    <label>Brief / Pesan
...
<section class="ae-map-full">
    <iframe src="https://www.google.com/maps?q=Jl.+Godo+Inten+UH+VI+No.50E,+Sorosutan,+Umbulharjo,+Yogyakarta&output=embed" width="100%" height="500" style="border:0;display:block;" loading="lazy"></iframe>
</section>
    ...
    <div class="ae-container">
        ...
        <div class="ae-faq-list">
            <details class="ae-faq-item">
                ...
                <p>Rata-rata 14–21 hari kerja untuk booth custom skala menengah, tergantung tingkat kompleksitas desain dan ketersediaan material. Untuk booth standar, prosesnya bisa lebih cepat (7–10 hari).</p>
            </details>
            <details class="ae-faq-item">
                <summary>Apakah Abadi Event melayani proyek di luar Yogyakarta?</summary>
                <p>Ya, kami melayani klien di seluruh Pulau Jawa — terutama Yogyakarta, Solo, Semarang, Surabaya, Bandung, dan Jakarta. Untuk lokasi lain di Indonesia, silakan diskusikan terlebih dahulu dengan tim kami.</p>
            </details>
            <details class="ae-faq-item">
            ...
            <details class="ae-faq-item">
                <summary>Apa yang membedakan Abadi Event dari kontraktor lain?</summary>
                <p>Tim in-house menangani seluruh tahap proyek — desain, produksi, instalasi, hingga bongkar — sehingga kualitas dan jadwal terjaga. Selain itu, RAB kami transparan tanpa biaya tersembunyi, didukung rating 5,0 di Google dari klien-klien sebelumnya.</p>
            </details>
        </div>
    </div>
</section>
...
<section class="ae-cta-footer">
    <div class="ae-container" style="text-align:center;">
        ...
        <p>Hubungi tim kami langsung — kami siap menjelaskan detail proyek Anda secara personal.</p>
...
document.getElementById('ae-quote-form').addEventListener('submit', function(){
    ...
    var name = v('qf-name'),
        ...
        msg = v('qf-msg');
    var lines = [
        'Halo Abadi Event, saya ingin request penawaran:',
        '',
        '*Nama:* ' + name,
